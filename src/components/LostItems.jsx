    ...
    <>
      ...
      <div className="mt-10  mx-auto ">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 gap-2 md:grid-cols-3 lg:gap-4 lg:grid-cols-3 w-[100%] xl:grid-cols-4">
            {lostItems.map((item) => (
              <NavLink
              ...
              >
                <div
                  key={item.id}
                  className="h-[40vh] truncate line-clamp-2  bg-[#FCA31126] rounded-xl shadow-md"
                >
                  <img
                    className="w-full rounded-tl-xl rounded-tr-xl h-[25vh]"
                    src={item.image}
                    alt={item.name}
                  />
